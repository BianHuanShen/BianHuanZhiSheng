document.addEventListener("DOMContentLoaded", () => {
    ...
    const menus = {
        "submenu-capitulos": [
            { nombre: "Capítulo 1 - Inicio", link: "capitulo1.html" },
            { nombre: "Capítulo 1 Parte II", link: "capitulo1actoII.html" },
            { nombre: "Capítulo 2 - El Despertar", link: "capitulo2.html" }
        ],

        "submenu-teorias": [
            { nombre: "Teoría del Cambio", link: "inicio.html" },
